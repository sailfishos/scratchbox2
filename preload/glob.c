/* Copied from glibc-2.42 to Scratchbox 2, with minimal modifications
...
# define FLEXIBLE_ARRAY_MEMBER /* SB2 */

# ifndef __readdir64 /* SB2 */
#  define __readdir64		readdir64
# endif

/* SB2: this is called "do_glob" / "do_glob64" in SB2,
 * "glob" & "glob64" are the wrappers */
# ifdef COMPILE_GLOB64
#  define __glob do_glob64
# else
#  define __glob do_glob
# endif
...
# define struct_stat64          struct stat64
# define GLOB_LSTAT             gl_lstat
# define GLOB_FSTATAT64         fstatat64
# endif /* _LIBC */
...
#ifndef __THROWNL /* SB2 - OS X Compat */
# define __THROWNL
#endif
